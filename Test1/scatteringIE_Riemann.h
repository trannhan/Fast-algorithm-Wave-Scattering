...
class ScatteringIE_Riemann
{
    ...
    private:        
        ...
        RealVector     x;                //collocation-point 3D position in a big cube
        RealVector     y;
        RealVector     z;
        Complex        ***GreenCube;
	Integer        GreenSize;
    ...
    public:
        ScatteringIE_Riemann()
        {

        }

        virtual ~ScatteringIE_Riemann()
        {
	     DeleteGreenCube();
        }
        ...
        {            
            ...
            NumCubePerSide = round(pow(TotalCubes,1.0/3));
    	 ...
    	 inline void Order2Index(Integer m,Integer& m1,Integer& m2,Integer& m3)
	 {
        ...
        void UniformDistributeCubes()
        {
            ...
            for(Integer s = 1; s < NumCubePerSide; s++)
            {
                t = SmallCubeSize*s;
                x[s] = t;
                y[s] = t;
